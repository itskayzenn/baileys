...
# NPM
"dependencies": {
   "@itskayzenn/baileys": "latest"
}

# GitHub
"dependencies": {
   "@itskayzenn/baileys": "github:itskayzenn/baileys"
}
```
...
```bash
# NPM
npm i @itskayzenn/baileys@latest

# GitHub
npm i github:itskayzenn/baileys
```

- 🧩 Import (ESM & CJS)
```javascript
// --- ESM
import { makeWASocket } from '@itskayzenn/baileys'

// --- CJS (tested and working on Node.js 24 ✅)
const { makeWASocket } = require('@itskayzenn/baileys')
```
...
```javascript
import { makeWASocket, delay, DisconnectReason, useMultiFileAuthState } from '@itskayzenn/baileys'
...
```javascript
import { makeWASocket, makeInMemoryStore, delay, DisconnectReason, useMultiFileAuthState } from '@itskayzenn/baileys'
import { Boom } from '@hapi/boom'
import pino from 'pino'
...
sock.sendMessage(jid, {
   ...
   publisher: '🌟 Kayzen',
   description: '@itskayzenn/baileys'
}, {
   quoted: message
})
```
...
sock.sendMessage(jid, {
   ...
   couponCode: '@itskayzenn/baileys', // --- Optional
   nativeFlow: [{
      text: '👋🏻 Greeting',
      id: '#Greeting'
   }, {
...
```javascript
import { getImageProcessingLibrary } from '@itskayzenn/baileys'
...
```javascript
// --- Create a new one
sock.newsletterCreate('@itskayzenn/baileys')
...
// --- Change name
sock.newsletterUpdateName('1231111111111@newsletter', '📦 @itskayzenn/baileys')
...
sock.groupCreate('@itskayzenn/baileys', ['628123456789@s.whatsapp.net'])
...
// --- Change name
sock.groupUpdateSubject(jid, '📦 @itskayzenn/baileys')
