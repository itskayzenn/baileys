...
const mediaAnnotation = [{
    ...
    newsletter: {
        // Kayzen@Note 03-02-26 --- You can change jid, message id, and name via .env (⁠≧⁠▽⁠≦⁠)
...
export const prepareWAMessageMedia = async (message, options) => {
    ...
    // Kayzen@Changes 06-02-26 --- Add few support for sending media to newsletter (⁠≧⁠▽⁠≦⁠)
    if (isNewsletter) {
...
// Kayzen@Changes 31-01-26 --- Extract product message into a standalone function so it can also be reused as the header for interactive messages
